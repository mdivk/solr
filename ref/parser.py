...
#I think you need to revisit this section of code on how to know if it is a directory or it is a file, the error
    ...
    for each_data in data:
        if each_data[0]:
            if isinstance(each_data, str):
                ...
                break
            try:
                fix_split = each_data[0].strip().replace('\x02', '').split('\x01')
